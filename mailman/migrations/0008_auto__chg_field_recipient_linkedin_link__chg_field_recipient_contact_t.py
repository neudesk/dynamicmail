...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipient.linkedin_link'
        db.alter_column(u'mailman_recipient', 'linkedin_link', self.gf('django.db.models.fields.TextField')(null=True))
        ...
        # Adding unique constraint on 'Recipient', fields ['email']
        db.create_unique(u'mailman_recipient', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Recipient', fields ['email']
        db.delete_unique(u'mailman_recipient', ['email'])


        # Changing field 'Recipient.linkedin_link'
        db.alter_column(u'mailman_recipient', 'linkedin_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Recipient.contact_title'
        db.alter_column(u'mailman_recipient', 'contact_title', self.gf('django.db.models.fields.CharField')(default=9, max_length=150))
