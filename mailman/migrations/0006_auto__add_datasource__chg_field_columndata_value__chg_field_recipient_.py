...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mailman_datasource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=150)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'mailman', ['DataSource'])


        # Changing field 'ColumnData.value'
        db.alter_column(u'mailman_columndata', 'value', self.gf('django.db.models.fields.TextField')(max_length=350))

        # Changing field 'Recipient.email'
        db.alter_column(u'mailman_recipient', 'email', self.gf('django.db.models.fields.EmailField')(default=9, max_length=75))

    def backwards(self, orm):
        # Deleting model 'DataSource'
        db.delete_table(u'mailman_datasource')


        # Changing field 'ColumnData.value'
        db.alter_column(u'mailman_columndata', 'value', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'Recipient.email'
        db.alter_column(u'mailman_recipient', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
