...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailData.web_handler'
        db.add_column(u'mailman_maildata', 'web_handler',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=9, to=orm['mailman.WebHandler']),
                      keep_default=False)

        # Deleting field 'WebHandler.mail_data'
        db.delete_column(u'mailman_webhandler', 'mail_data_id')


    def backwards(self, orm):
        # Deleting field 'MailData.web_handler'
        db.delete_column(u'mailman_maildata', 'web_handler_id')

        # Adding field 'WebHandler.mail_data'
        db.add_column(u'mailman_webhandler', 'mail_data',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=9, to=orm['mailman.MailData']),
                      keep_default=False)
