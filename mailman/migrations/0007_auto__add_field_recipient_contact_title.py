...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipient.contact_title'
        db.add_column(u'mailman_recipient', 'contact_title',
                      self.gf('django.db.models.fields.CharField')(default=8, max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipient.contact_title'
        db.delete_column(u'mailman_recipient', 'contact_title')
    ...
    models = {
        ...
        u'mailman.recipient': {
            ...
            'contact_title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
